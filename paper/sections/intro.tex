...
over \(\Rationals/\Reals/\Complex\) since the
rationalisation~\cite{dps2025}, 49 over \Integers. We refuse to merge
across fields and require every rank claim in the catalog (and in
...
catalog shape -- a \emph{frontier closure} -- and the resulting wins
...
frontier-closure search, and Section \ref{sec:balance} the empirical
